...
There are many diseases associated with cleavage and polyadenlyation activites, including cancer, aging, and skin-related diseases.  For example, FIP1L1 gene, which plays a role in leukemia (Ali <i>et al.</i>, 2023), enhances usage of proximal PASs (global 3'UTR shortening), while knockdown of FIP1L1 leads to usage of distal PASs (global 3'UTR lengthening) (Davis <i>et al.</i>, 2022, Li <i>et al.</i>, 2015).  By profileing FIP1L1 based on expression level and modeling, PAS genomic locations chr4:+:53459611 (PolyAID: 0.9986, PolyAStrength: 0.5618, PolyA_SVM: 0.9911) and chr4:+:53459667 (PolyAID: 0.9768, PolyAStrength: -7.8462, PolyA_SVM: 0.9750) ranked at the top two (Figure 2).  The result from APARENT2 shows that FIP1L1 has preference for proximal PASs (delta log-odds-narrow < 0) (Figure 5), which confirms with previous findings.  Similarly, CSTF2 gene, which involved in cancer, and proliferating cells (Xia <i>et al.</i>, 2014), favors 3'UTR shortening and is in accordance with the APARENT2 result (preference for proximal PASs; genomic locations: chrX:+:100840916, chrX:+:100841518; delta log-odds-narrow < 0) (Figure 2, 5).  In addition to cancer, RRAS2 gene is also associated with aging.  It is reported that RRAS2 promotes 3'UTR lengthening in aging process, as in senescent cells (chen <i>et al.</i>, 2018).  Profiling of RRAS2 and comparison of proximal (chr11:-:14278745) and distal PASs (chr11:-:14277918) shows that RRAS2 has the same preference for distal PASs (delta log-odds-narrow > 0) (Figure 2, 5).  In skin.
